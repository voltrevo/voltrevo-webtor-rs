...
//! }
//!
//! // For tests that require SubtleCrypto (WASM-only):
//! #[cfg(target_arch = "wasm32")]
//! #[wasm_test_async]
//! async fn my_wasm_only_test() {
//!     // Uses SubtleCrypto APIs
//! }
//! ```
...
// These tests will only compile and run on WASM targets
#[cfg(target_arch = "wasm32")]
pub use wasm_bindgen_test::wasm_bindgen_test as wasm_test;
